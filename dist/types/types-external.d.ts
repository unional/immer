 ...
 */
export declare type IfAvailable<T, Fallback = void> =
	| true
...
export declare type Immutable<T> = T extends PrimitiveType
	? T
	: T extends AtomicObject
	? T
	: T extends IfAvailable<ReadonlyMap<infer K, infer V>>
...
export declare type PatchListener = (
	patches: Patch[],
...
export declare type Produced<Base, Return> = Return extends void
	? Base
...
declare type ValidRecipeReturnTypePossiblyPromise<State> =
 ...
 */
declare type InferRecipeFromCurried<Curried> = Curried extends (
	base: infer State,
	...rest: infer Args
) => any
	? ReturnType<Curried> extends State
		...
		: never
	: never
declare type InferInitialStateFromCurried<Curried> = Curried extends (
	base: infer State,
	...rest: any[]
) => any
	? State
	: never
declare type InferCurriedFromRecipe<
	Recipe,
	UsePatches extends boolean
> = Recipe extends (draft: infer DraftState, ...args: infer RestArgs) => any
	? ReturnType<Recipe> extends ValidRecipeReturnTypePossiblyPromise<DraftState>
		...
		: never
	: never
declare type InferCurriedFromInitialStateAndRecipe<
	State,
	Recipe,
	UsePatches extends boolean
> = Recipe extends (
