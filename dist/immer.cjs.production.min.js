...
function t(n) {
	...
	return (
		...
		((function(n) {
			...
			Array.isArray(n) ||
			!!n[G] ||
			!!(null === (r = n.constructor) || void 0 === r ? void 0 : r[G]) ||
			c(n) ||
			v(n))
	)
}
function e(n, r, t) {
	void 0 === t && (t = !1),
		0 === i(n)
			? (t ? Object.keys : T)(n).forEach(function(e) {
...
function l(n, u) {
	return (
		...
		h(n) || r(n) || !t(n)
			? n
			: (i(n) > 1 && (n.set = n.add = n.clear = n.delete = d),
			  Object.freeze(n),
			  u &&
					e(
						n,
...
function S(r, e) {
	...
	return (
		...
		u
			? (i[H].M && (j(e), n(4)),
			  t(r) && ((r = P(e, r)), e.l || g(e, r)),
			  e.o && y("Patches").g(i[H].u, r, e.o, e.v))
			: (r = P(e, i, [])),
		j(e),
		e.o && e.s(e.o, e.v),
		r !== B ? r : void 0
...
function P(n, r, t) {
	...
	if (i.A !== n) return r
	if (!i.M) return g(n, i.u, !0), i.u
	if (!i.R) {
		;(i.R = !0), i.A.m--
		var u = 4 === i.t || 5 === i.t ? (i.i = p(i.k)) : i.i
		e(3 === i.t ? new Set(u) : u, function(r, e) {
			return M(n, i, u, r, e, t)
		}),
			g(n, u, !1),
			t && n.o && y("Patches").F(i, t, n.o, n.v)
	}
	return i.i
}
function M(n, e, i, o, a, c) {
	if (r(a)) {
		var v = P(n, a, c && e && 3 !== e.t && !u(e.N, o) ? c.concat(o) : void 0)
		if ((f(i, o, v), !r(v))) return
		n._ = !1
	}
	if (t(a) && !h(a)) {
	...
	return (
		...
		(function n(r) {
			...
			var u,
				...
				c = i(r)
			if (a) {
				if (!a.M && (a.t < 4 || !y("ES5").J(a))) return a.u
				;(a.R = !0), (u = N(r, c)), (a.R = !1)
			} else u = N(r, c)
			return (
				e(u, function(r, t) {
...
function D() {
	...
	_("ES5", {
		I: function(r, t) {
			...
			return Object.defineProperty(i, H, {value: u, writable: !0}), i
		},
		P: function(n, i, f) {
			f
				? r(i) && i[H].A === n && t(n.p)
							...
							if (r && "object" == typeof r) {
								...
								if (t) {
									...
									if (4 === c)
										...
										if ((o(t) && (E(t), (a.length = !0)), f.length < i.length))
											for (var v = f.length; v < i.length; v++) a[v] = !1
										else for (var s = i.length; s < f.length; s++) a[s] = !0
										for (
											var p = Math.min(f.length, i.length), l = 0;
											l < p;
											l++
										)
											f.hasOwnProperty(l) || (a[l] = !0),
												void 0 === a[l] && n(f[l])
									}
								}
							}
...
function K() {
	...
	_("Patches", {
				...
				t.forEach(function(t) {
					for (var e = t.path, u = t.op, a = r, c = 0; c < e.length - 1; c++) {
						...
						;(0 !== v && 1 !== v) ||
							...
							n(24),
							"function" == typeof a && "prototype" === p && n(24),
							"object" != typeof (a = o(a, p)) && n(15, e.join("/"))
					}
					var l = i(a),
						d = f(t.value),
						h = e[e.length - 1]
								...
								t.push(
									...
									i.push(
										l === s
											? {op: "remove", path: d}
											: "remove" === l
											? {op: s, path: d, value: a(v)}
											: {op: "replace", path: d, value: a(v)}
									)
							}
						})
					})(n, r, t, i)
				...
				case 1:
					return (function(n, r, t, e) {
						...
						for (var v = 0; v < i.length; v++)
							if (u[v] && o[v] !== i[v]) {
								var p = r.concat([v])
								t.push({op: "replace", path: p, value: a(o[v])}),
									e.push({op: "replace", path: p, value: a(i[v])})
							}
						for (var l = i.length; l < o.length; l++) {
							var d = r.concat([l])
							t.push({op: s, path: d, value: a(o[l])})
						}
						i.length < o.length &&
							e.push({
								op: "replace",
		...
		g: function(n, r, t, e) {
			t.push({op: "replace", path: [], value: r === B ? void 0 : r}),
		...
		a = (function() {
			...
			return (
				...
				(u.set = function(n, r) {
					...
					return (
						o(t),
						(s(t).has(n) && s(t).get(n) === r) ||
							(i(t), E(t), t.N.set(n, !0), t.i.set(n, r), t.N.set(n, !0)),
						this
					)
				}),
				(u.delete = function(n) {
					...
					return (
						...
						i(r),
						E(r),
						r.u.has(n) ? r.N.set(n, !1) : r.N.delete(n),
						r.i.delete(n),
						!0
					)
				}),
			...
			return (
				...
				(t.has = function(n) {
					...
					return (
						o(r),
						r.i
							? !!r.i.has(n) || !(!r.p.has(n) || !r.i.has(r.p.get(n)))
							: r.u.has(n)
					)
				}),
				(t.add = function(n) {
				...
				(t.delete = function(n) {
					...
					return (
						...
						u(r),
						E(r),
						r.i.delete(n) || (!!r.p.has(n) && r.i.delete(r.p.get(n)))
					)
				}),
				(t.clear = function() {
					var n = this[H]
...
var I,
	...
	Y = {
		...
		set: function(n, r, t) {
			...
			return (
				!!(
					(n.i[r] === t && (void 0 !== t || r in n.i)) ||
					(Number.isNaN(t) && Number.isNaN(n.i[r]))
				) || ((n.i[r] = t), (n.N[r] = !0), !0)
			)
		},
		deleteProperty: function(n, r) {
			return (
				void 0 !== A(n.u, r) || r in n.u
					? ((n.N[r] = !1), R(n), E(n))
					: delete n.N[r],
				n.i && delete n.i[r],
				!0
			...
			;(this.S = q),
				...
				(this.produce = function(r, i, u) {
					if ("function" == typeof r && "function" != typeof i) {
						...
						return function(n) {
							...
							void 0 === n && (n = o)
							for (
								var t = arguments.length, e = Array(t > 1 ? t - 1 : 0), u = 1;
								u < t;
								u++
							)
								e[u - 1] = arguments[u]
				...
				(this.produceWithPatches = function(n, r) {
					if ("function" == typeof n)
						return function(r) {
							for (
								var t = arguments.length, i = Array(t > 1 ? t - 1 : 0), u = 1;
								u < t;
								u++
							)
								i[u - 1] = arguments[u]
...
;(exports.Immer = nn),
	(exports.applyPatches = fn),
	(exports.castDraft = function(n) {
		return n
	}),
